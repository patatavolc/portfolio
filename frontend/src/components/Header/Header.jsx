      ...
      <div className="flex justify-between border border-gray-300 rounded-full bg-black/30 backdrop-blur-md 
        ...
        <div>
          <nav className="text-white text-2xl font-bold flex gap-3 ">
            <a 
              className="group px-1 py-2 text-sm font-medium" 
              href="#home"
              onClick={() => setActiveLink('home')}
            >
              <span className={`relative inline-block transition-colors duration-300 font-semibold ${
                activeLink === 'home' 
                  ? 'text-transparent bg-clip-text bg-linear-to-r from-[#FAD4D8] to-[#FC440F]' 
                  : 'text-white'
              }`}>
                Home
                <span className="absolute left-0 top-full translate-y-1 w-full h-0.5 bg-linear-to-r from-[#fad4d8] to-[#fc440f] transform origin-left transition-transform duration-300 scale-x-0 group-hover:scale-x-100" aria-hidden="true"></span>
              </span>
            </a>
