...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:edermoros3@gmail.com?subject=${encodeURIComponent(
      form.subject || `Contact from ${form.fullName}`
  ...
  return (
    <section className="flex flex-col justify-center items-center py-16 px-4">
      ...
      <div className="flex gap-6 mt-8">
        <a
          href="https://github.com/patatavolc"
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-400 hover:text-[#fc440f] transition-colors duration-200"
          aria-label="GitHub Profile"
        >
          <GitHubIcon />
        </a>
        <a
          href="https://www.linkedin.com/in/eder-moros-59783b34b/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-400 hover:text-[#fc440f] transition-colors duration-200"
